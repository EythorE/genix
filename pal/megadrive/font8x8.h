/*
 * 8x8 bitmap font for VDP tiles — ASCII 0x20-0x7F (96 glyphs)
 * Each glyph is 8 rows of 8 pixels.
 * VDP tiles are 8x8 with 4bpp (4 bytes per row, 32 bytes per tile).
 * We store 1bpp here and expand at load time.
 */
...
static const unsigned char font_8x8[96][8] = {
    ...
    /* 0x41 'A' */ {0x18,0x24,0x42,0x7E,0x42,0x42,0x42,0x00},
    ...
    /* 0x5E '^' */ {0x18,0x24,0x00,0x00,0x00,0x00,0x00,0x00},
    ...
    /* 0x66 'f' */ {0x0C,0x10,0x3C,0x10,0x10,0x10,0x10,0x00},
    ...
    /* 0x6A 'j' */ {0x04,0x00,0x04,0x04,0x04,0x04,0x44,0x38},
    ...
    /* 0x74 't' */ {0x10,0x10,0x3C,0x10,0x10,0x10,0x0C,0x00},
